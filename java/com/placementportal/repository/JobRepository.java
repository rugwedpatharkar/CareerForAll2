...
public interface JobRepository extends JpaRepository<Job, Integer> {
	...
	List<Job> findJobByCompanyidAndIgnoreCase(@Param("companyid") Long companyid, @Param("postedOn") Date postedOn,
...
//	List<Job> findJobByCompanyidAndIgnoreCase(@Param("companyid") Long companyid, @Param("country") String country,
...
//			);
	...
	List<Job> findJobByCompanyidAndIgnoreCase(@Param("companyid") Long companyid, @Param("keyword") String keyword);
